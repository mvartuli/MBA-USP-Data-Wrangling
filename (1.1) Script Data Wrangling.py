...
dados_tempo.iloc[3,] # seleciona a linha de índice 3
...
dados_tempo.iloc[5,4] # seleciona sexta linha e quinta coluna
...
dados_tempo.tempo.quantile([0.10, 0.20]) # com uma só coluna pode usar a sintaxe df.coluna
...
dados_periodo = dados_tempo.groupby(['periodo']) # o resultado é um DataFrameGroup, não um DataFrame
...
# Usando o critério "não" que é o ~ (inverte o argumento)
